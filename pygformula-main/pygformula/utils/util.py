...
def error_catch(obs_data, id, time_points, interventions, intervention_dicts, int_descript, custom_histvars,
    ...
    ymodel_type: Str
        A string to indicate the type of model for the outcome variable (currently implemented for Random Forests)
...
def get_output(ref_int, int_descript, censor, obs_res, g_results, time_points, ci_method, time_name, obs_means,
    ...
    elif outcome_type == 'binary_eof' or outcome_type == 'continuous_eof' or outcome_type == 'nonparametric':
